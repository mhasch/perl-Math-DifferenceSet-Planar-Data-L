...
pds_4875.db - size L database with planar difference set samples
...
It contains 4875 cyclic planar difference set planes with orders
ranging from 2 to 46337.  For all planes, std reference sets are included.
